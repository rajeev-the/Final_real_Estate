...
const Layout = () => {
  ...
  const openWhatsApp = () => {
  const encodedMessage ="Hello, I want to explore opportunities to invest in land or list my land through Landsathi. Kindly share the process to get started."
  const cleanNumber ="+919625744005"
